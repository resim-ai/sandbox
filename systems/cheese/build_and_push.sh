...
LOCAL_TAG="cheese:latest"
LOCAL_METRICS_TAG="cheese_metrics:latest"
...
_set_default RESIM_SANDBOX_BUILD_TAG_PREFIX "cheese_"
_set_default RESIM_SANDBOX_METRICS_BUILD_TAG_PREFIX "cheese_metrics_"
_set_default RESIM_SANDBOX_BUILD_BRANCH "cheese_sandbox"
